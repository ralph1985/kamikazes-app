...
- participación anual y económica unificadas, incluyendo años sin participación;
...
La lista de compra se mostrará como una tabla horizontal editable directamente. La columna `Producto` permanecerá fija al desplazarse horizontalmente y la cabecera incluirá una segunda fila con filtros por producto, tienda, categoría, asignación y estado. En móvil se conservará la tabla con desplazamiento horizontal.

Las celdas de producto, tienda, categoría, asignación, cantidades, precios, notas y estado se editarán al hacer clic. El valor se guardará al perder el foco, mostrando los estados de guardado y error. Los totales calculados no serán editables.

La cabecera de la tabla permanecerá visible e incluirá estos indicadores, calculados sobre toda la edición aunque haya filtros activos: `Presupuestado` como cantidad presupuestada por precio presupuestado; `En carrito` como cantidad real por precio real de los productos con estado `En carrito`; `Compra real` como suma de los importes de compras respaldadas por tickets; `Presupuesto general` como el saldo previsto del presupuesto de la edición; `Disponible ahora` como presupuesto general menos el total en carrito; y `Disponible real` como presupuesto general menos la compra real.
...
- La participación de un miembro en una edición implica su participación económica en esa edición y es independiente de su cuenta y del catering.
- La primera pantalla operativa de participantes permitirá consultar todos los miembros, activar o desactivar su participación anual/económica y asignar su tarifa; sólo administradores y editores de presupuesto podrán modificarla mientras la edición permanezca abierta.
- El catering tendrá su propia relación independiente: una persona podrá participar sólo en presupuesto, sólo en catering o en ambos.
- La primera rebanada de presupuesto permitirá crear tarifas con nombre e importe y mostrará el resumen económico; la asignación individual se hará desde Participantes.
...
- El Hito 8 queda pendiente de validación funcional por Rafa. El Hito 9 queda pendiente de validación funcional por Rafa tras implementar inventario por ubicación, movimientos auditados y sobrantes por edición, con permisos de compras/inventario.
