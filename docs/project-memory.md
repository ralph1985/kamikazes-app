...
- El Hito 6 está en desarrollo por bloques; la primera rebanada cubre productos de compra por edición con categorías, tiendas, estados y cantidades/precios previstos y reales. El segundo bloque añade copia explícita de previsión desde otra edición y preferencias de lista por miembro; los productos no se eliminan.
